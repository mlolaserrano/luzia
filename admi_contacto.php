...
<main>
  ...
  <div class="position-relative">
    <img src="img/contacto_banner.jpg" alt="Joyas Luzia banner de contacto" class="img-fluid rounded">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-luzia">Agregar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalModificar" tabindex="-1" aria-labelledby="modalModificarLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="file" class="form-control" accept="image/*">
        <small class="form-text">Seleccioná una nueva imagen para reemplazar la actual.</small>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-luzia" data-bs-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="modalEliminar" tabindex="-1" aria-labelledby="modalEliminarLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-luzia" data-bs-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-luzia">Eliminar</button>
        </div>
        </div>
        </div>
      </div>
...
<div class="col-md-6">
  ...
  <div class="d-flex flex-wrap gap-2 mb-3">
    ...
    <button type="button" class="btn btn-luzia" data-bs-toggle="modal" data-bs-target="#formModal">CONSULTANOS</button>
  </div>
  <br>
  ...
  <div class="d-flex flex-wrap gap-2">
    ...
    <button class="btn btn-modify btn-management" data-bs-toggle="modal" data-bs-target="#modalTelefono" title="Modificar teléfono">
      <i class="bi bi-telephone"></i>
    </button>
    <button class="btn btn-modify btn-management" data-bs-toggle="modal" data-bs-target="#formModalAdmin" title="Modificar formulario">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" class="form-control mb-3" value="¡Contáctanos!">
        <label class="form-label">Descripción</label>
        <textarea class="form-control" rows="4">No hay pregunta demasiado pequeña...</textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-luzia" data-bs-dismiss="modal">Guardar</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="tel" class="form-control" value="+5491122233344">
        <small class="form-text">Formato internacional recomendado</small>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-luzia" data-bs-dismiss="modal">Guardar</button>
      </div>
...
<!--mod de form-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalAdminLabel">Modificar Formulario</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
      </div>
      <div class="modal-body">
        <label class="form-label">Etiqueta Nombre</label>
        <input type="text" class="form-control mb-3" value="Nombre completo*">
        <label class="form-label">Etiqueta Email</label>
        <input type="text" class="form-control mb-3" value="Correo electrónico*">
        <label class="form-label">Etiqueta Consulta</label>
        <input type="text" class="form-control mb-3" value="Consulta*">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-luzia" data-bs-dismiss="modal">Guardar</button>
      </div>
