        ...
        <div class="container-fluid position-relative">
          ...
          <div class="collapse navbar-collapse d-none d-lg-flex">
            <ul class="navbar-nav mx-lg-3 me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="productos_anillos.php">Anillos</a>
              </li>
              <li class="nav-item">
            ...
            <div class="d-flex ms-lg-auto">
              <a class="btn" href="mi_cuenta.php" aria-label="Usuario">
      ...
      >
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link py-2 active" href="productos_anillos.php">Anillos</a>
            </li>
            <li class="nav-item">
